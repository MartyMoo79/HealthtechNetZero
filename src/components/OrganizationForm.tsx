...
interface Props {
  onSubmit: (info: OrganisationInfo) => void;
}

export default function OrganisationForm({ onSubmit }: Props) {
  const [info, setInfo] = React.useState<OrganisationInfo>({
    orgName: '',
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div className="relative">
            ...
            <input
              ...
              value={info.orgName}
              onChange={(e) => setInfo({ ...info, orgName: e.target.value })}
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) => setInfo({ ...info, personName: e.target.value })}
            />
          </div>
